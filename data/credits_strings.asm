...
.MobilePrjLeader:     db "PROYECTO LÍDER MÓVIL@"      ; "モバイルプロジェクト　りーダー@"
.MobileSystemAd:      db "CONSEJERO SIS. MÓVIL@"      ; "モバイル　システムアドバイザー@"
.MobileStadiumDir:    db " DIR. ESTADIO MÓVIL@"       ; "モバイルスタジアム　ディレクター@"
